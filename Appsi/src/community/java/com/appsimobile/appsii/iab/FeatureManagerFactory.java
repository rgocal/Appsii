...
public class FeatureManagerFactory {
    ...
    public static FeatureManager getFeatureManager(Context context) {
        if (sFeatureManager == null) {
            sFeatureManager = new CommunityFeatureManagerImpl(context);
        }
        return sFeatureManager;
    }

    public static IabPurchaseHelper.OnIabPurchaseFinishedListener wrapListener(String sku,
            IabPurchaseHelper.OnIabPurchaseFinishedListener purchaseListener) {
