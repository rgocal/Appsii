...
/**
 * Copied from: https://github.com/idunnololz/AnimatedExpandableListView
 * <p/>
 * <p/>
            ...
            if (info.animating) {
                ...
                if (convertView instanceof DummyView == false) {
                    ...
                    convertView.setLayoutParams(
                            new AbsListView.LayoutParams(LayoutParams.MATCH_PARENT, 0));
                }
                ...
                return getRealChildView(groupPosition, childPosition, isLastChild, convertView,
                        parent);
            }
        }
