...
public abstract class LoaderManager {
    ...
    @VisibleForTesting
    public static LoaderManager createInstance(Appsi appsi, boolean started) {
...
class LoaderManagerImpl extends LoaderManager {
    ...
    LoaderManagerImpl(String who, Appsi activity, boolean started) {
        mWho = who;
        mActivity = activity;
        mStarted = started;
    }

    void updateActivity(Appsi activity) {
        mActivity = activity;
    }
