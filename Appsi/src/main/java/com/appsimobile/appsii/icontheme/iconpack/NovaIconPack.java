 ...
 */
public class NovaIconPack extends AbstractIconPack {

    public static final String NOVA_PACK_ID = "nova";
    ...
    public NovaIconPack(String packageName) {
        mPackageName = packageName;
        mIconPackUri = createIconPackUri(NOVA_PACK_ID, packageName);
    }

    public NovaIconPack(Uri uri, String packageName) {
        mPackageName = packageName;
        mIconPackUri = uri;
    }
    ...
    public void initialize(Context context) {
        ...
        try {
            ...
            Log.w("NovaIconPack", "error parsing nova theme", e);
        } catch (IOException e) {
            Log.w("NovaIconPack", "error while parsing nova theme", e);
        }
    }
    ...
    public Bitmap loadIconImpl(Context context, ComponentName componentName) {
        try {
            ...
            Log.w("NovaIconPack", "error opening theme", e);
        }
