 ...
 */
public class CellProfileImageActivity extends AppCompatActivity {
    ...
    private void handleIntent(Intent intent, boolean isNewIntent) {
        ...
        ProfileImageFragment fragment =
                (ProfileImageFragment) getFragmentManager().findFragmentByTag("clock");
        ...
        if (isNewIntent || fragment == null) {
            fragment = ProfileImageFragment.createInstance(cellId);
