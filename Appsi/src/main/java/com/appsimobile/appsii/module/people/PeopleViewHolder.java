 ...
 */
public class PeopleViewHolder extends AbstractPeopleViewHolder {
    ...
    public PeopleViewHolder(View itemView,
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onItemClickListener.onItemClick(PeopleViewHolder.this);
            }
        });
    ...
    @Override
    public void bind(BaseContactInfo info, String firstLetter, boolean isFirstWithLetter) {
        ContactView contactView = (ContactView) itemView;
        contactView.bindToData(info);
        contactView.setFirstLetter(firstLetter);
        contactView.setFirstLetterOfKind(isFirstWithLetter);

    }

    public BaseContactInfo getContactInfo() {
        return ((ContactView) itemView).getContactInfo();
    }

    public interface OnItemClickListener {

        void onItemClick(AbstractPeopleViewHolder viewHolder);
    }
