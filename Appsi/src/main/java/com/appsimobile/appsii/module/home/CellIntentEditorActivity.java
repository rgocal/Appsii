...
/**
 * Created by nick on 28/01/15.
 */
public class CellIntentEditorActivity extends AppCompatActivity {
    ...
    private void handleIntent(Intent intent, boolean isNewIntent) {
        ...
        IntentEditorFragment fragment =
                (IntentEditorFragment) getFragmentManager().findFragmentByTag("intent");
        ...
        if (isNewIntent || fragment == null) {
            fragment = IntentEditorFragment.createInstance(cellId);
            getFragmentManager().beginTransaction().
                    add(R.id.container, fragment, "intent").
                    commit();
        }
