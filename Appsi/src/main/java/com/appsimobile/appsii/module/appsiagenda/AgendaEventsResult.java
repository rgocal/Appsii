 ...
 */
public class AgendaEventsResult {

    final List<AgendaEvent> mAgendaEvents;

    final PermissionDeniedException mPermissionDeniedException;


    public AgendaEventsResult(List<AgendaEvent> agendaEvents) {
        mPermissionDeniedException = null;
        mAgendaEvents = agendaEvents;
    }

    public AgendaEventsResult(PermissionDeniedException permissionDeniedException) {
