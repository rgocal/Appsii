...
public abstract class MonthView extends View {
    ...
    public static final String VIEW_PARAMS_START_JULIAN_DAY = "start_julian_day";
    ...
    protected Paint mEventDayCirclePaint;
    ...
    public MonthView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MonthView, 0,
                R.style.MonthViewStyle);
        ...
        mTodayNumberColor =
                a.getColor(R.styleable.MonthView_monthview_todayNumberColor, 0xFF33b5e5);
        ...
        mMonthTitleBGColor =
                a.getColor(R.styleable.MonthView_monthview_monthTitleBGColor, 0xFFF2F2F2);


        MINI_DAY_NUMBER_TEXT_SIZE =
                a.getDimensionPixelSize(R.styleable.MonthView_monthview_miniDayNumberTextSize, 24);
        MONTH_LABEL_TEXT_SIZE =
                a.getDimensionPixelSize(R.styleable.MonthView_monthview_monthLabelTextSize, 24);
        MONTH_DAY_LABEL_TEXT_SIZE =
                a.getDimensionPixelSize(R.styleable.MonthView_monthview_monthDayLabelTextSize, 24);
        MONTH_HEADER_SIZE =
                a.getDimensionPixelOffset(R.styleable.MonthView_monthview_headerSize, 24);
        DAY_SELECTED_CIRCLE_SIZE =
                a.getDimensionPixelSize(R.styleable.MonthView_monthview_daySelectedCircleSize, 24);
    ...
    protected String getWeekDayName(int calendarDay) {
        ...
        String displayName = mDayLabelCalendar.getDisplayName(
    ...
    protected void drawMonthNums(Canvas canvas) {
        ...
        for (int dayNumber = 1; dayNumber <= mNumCells; dayNumber++) {
            ...
            int julianDay = mStartJulianDay + dayNumber - 1;
            boolean hasEvents = mController != null && mController.hasEventOnJulianDay(julianDay);
    ...
    public abstract void drawMonthDay(Canvas canvas, int year, int month, int day,
            int x, int y, int startX, int stopX, int startY, int stopY, boolean hasEvents);
     ...
     * {@link com.appsimobile.appsii.module.appsiagenda.MonthView.OnDayClickListener} if one is set.
     * <p/>
