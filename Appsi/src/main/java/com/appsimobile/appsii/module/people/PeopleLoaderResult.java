 ...
 */
public class PeopleLoaderResult {

    final List<? extends BaseContactInfo> mResult;

    final PermissionDeniedException mPermissionDeniedException;

    public PeopleLoaderResult(List<? extends BaseContactInfo> result) {
        mResult = result;
        mPermissionDeniedException = null;
    }

    public PeopleLoaderResult(PermissionDeniedException permissionDeniedException) {
