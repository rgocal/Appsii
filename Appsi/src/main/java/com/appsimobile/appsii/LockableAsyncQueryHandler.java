...
/**
 * Created by nick on 15/02/15.
 */
public class LockableAsyncQueryHandler extends Handler {

    static final ReadWriteLock READ_WRITE_LOCK = new ReentrantReadWriteLock();

    static final Lock READ_LOCK = READ_WRITE_LOCK.readLock();

    static final Lock WRITE_LOCK = READ_WRITE_LOCK.writeLock();

    static final String TAG = "AsyncQuery";
