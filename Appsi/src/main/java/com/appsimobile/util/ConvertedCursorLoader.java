 ...
 */
public abstract class ConvertedCursorLoader<T> extends AsyncTaskLoader<T> {
     ...
     */
    public ConvertedCursorLoader(Context context) {
        super(context);
    ...
    protected abstract void cleanup(T old);
