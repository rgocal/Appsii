...
public class SVGParser {
     ...
     *
     * @param pathString the SVG path, see the specification <a href="http://www.w3
     * .org/TR/SVG/paths.html">here</a>.
     */
    ...
    private static void drawArc(Path p, float lastX, float lastY, float x, float y, float rx,
        ...
        // Log.d("drawArc", "from (" + lastX + "," + lastY + ") to (" + x + ","+ y + ") r=(" + rx
        // + "," + ry +
    ...
    static class SVGHandler extends DefaultHandler {
        ...
        public void startElement(String namespaceURI, String localName, String qName,
            ...
            if (localName.equals("svg")) {
                ...
                // When stroke is none, explicitly do not inherit
                // added by nickmartens1980
                if (strokeSet) {
                    strokeSet = !"none".equalsIgnoreCase(props.getString("stroke"));
                }
