...
public abstract class ResourceDragSortCursorAdapter extends DragSortCursorAdapter {
     ...
     * {@link CursorAdapter#CursorAdapter(android.content.Context, android.database.Cursor,
     * boolean)}; it is recommended
     * you not use this, but instead {@link #ResourceCursorAdapter(android.content.Context, int,
