...
public class DragSortListView extends ListView {
    ...
    private SmoothAnimator mRemoveAnimator;
    ...
    public DragSortListView(Context context, AttributeSet attrs) {
        ...
        if (removeAnimDuration > 0) {
            ...
            mRemoveAnimator = new RemoveAnimatorWithLeaveBehind(smoothness, 150);
        }
     ...
     * Collapses expanded items.
     */
    private class RemoveAnimatorWithLeaveBehind extends SmoothAnimator {
        ...
        public RemoveAnimatorWithLeaveBehind(float smoothness, int duration) {
            super(smoothness, duration);
        }
     ...
     * wrapped item.
     */
    void adjustItem(int position, View v, boolean invalidChildHeight) {
    ...
    void doDragFloatView(boolean forceInvalidate) {
     ...
     * {@link com.mobeta.android.dslv.DragSortListView#setDragScrollProfile(com.mobeta.android
     * .dslv.DragSortListView.DragScrollProfile)} to
     * set custom profile.
     *
     * @author heycosmo
     */
...
//            mBuilder.append("    <SecondExpPos>").append(mSecondExpPos).append
// ("</SecondExpPos>\n");
